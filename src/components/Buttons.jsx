...
export function Buttons ({ inputHandler, clearInput, backspace, changePlusMinus, calculateAns }) {
  ...
  return (
    <div className={styles.show_btn}>
      ...
      <button className="btn exp equal" id={styles.equalbtn} onClick={calculateAns}>
        =
      </button>
    </div>
  );
